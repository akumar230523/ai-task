            ...
            <div className="bg-white rounded-xl shadow-sm border overflow-hidden">
                <div className="p-4 sm:p-6 lg:p-8">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h2 className="text-lg sm:text-xl font-bold text-gray-900">Data Analysis</h2>
                            <p className="text-xs sm:text-sm text-gray-500">Data insights and visualization guidance</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                        ...
                        <div className="sm:col-span-2">
                            <label className="block text-sm font-medium text-gray-700 mb-2">
                                Analysis Goal <span className="text-red-500">*</span>
                            </label>
                            <input
                                type="text"
                    ...
                    <div className="border-t bg-gray-50">
                        <div className="p-4 sm:p-6 lg:p-8">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
                                <h3 className="text-lg font-bold text-gray-900">Data Analysis Plan</h3>
